...
try
    ...
    % Row 1.
    try, if isfield(S,'hFCLoad') && ishghandle(S.hFCLoad), set(S.hFCLoad,'Parent',pTop,'Units','normalized','Position',[0.020 0.570 0.135 0.330],'FontSize',11.0,'FontWeight','bold'); end, catch, end
    try, if isfield(S,'hFCScan') && ishghandle(S.hFCScan), set(S.hFCScan,'Parent',pTop,'Units','normalized','Position',[0.165 0.570 0.110 0.330],'FontSize',11.0,'FontWeight','bold'); end, catch, end
    ...
    try, if isfield(S,'hFCLabelMode') && ishghandle(S.hFCLabelMode), set(S.hFCLabelMode,'Parent',pTop,'Units','normalized','Position',[0.930 row2 0.065 hCtl],'FontSize',fsCtl); end, catch, end

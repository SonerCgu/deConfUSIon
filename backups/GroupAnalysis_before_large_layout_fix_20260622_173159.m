...
f=figure('Name','FC-GA large interactive view','Color',[0.08 0.08 0.08],'NumberTitle','off','MenuBar','none','ToolBar','figure','Position',[40 35 1680 960]); guidata(f,S); setappdata(f,'mainFig',hFig);
ax=axes('Parent',f,'Units','normalized','Position',[0.055 0.105 0.750 0.820]); setappdata(ax,'FCGA_FORCE_ALL_TICKS',true);
...
for k=1:numel(labels), uicontrol(f,'Style','text','String',labels{k},'Units','normalized','Position',[0.825 y 0.080 0.030],'BackgroundColor',[0.08 0.08 0.08],'ForegroundColor',[1 1 1],'FontWeight','bold','FontSize',10,'HorizontalAlignment','left'); y=y-0.060; end
y=0.890;
...
hAutoY=uicontrol(f,'Style','checkbox','String','Y auto','Value',1,'Units','normalized','Position',[0.825 0.315 0.080 0.035],'BackgroundColor',[0.08 0.08 0.08],'ForegroundColor',[1 1 1],'FontSize',10); hY0=uicontrol(f,'Style','edit','String','0','Units','normalized','Position',[0.910 0.315 0.035 0.035],'FontSize',10); hY1=uicontrol(f,'Style','edit','String','1.5','Units','normalized','Position',[0.955 0.315 0.035 0.035],'FontSize',10);
uicontrol(f,'Style','pushbutton','String','Update','Units','normalized','Position',[0.825 0.245 0.075 0.050],'BackgroundColor',[0.10 0.45 0.95],'ForegroundColor','w','FontWeight','bold','FontSize',10,'Callback',@(src,evt)fcGALargeReplot_20260622(f));
uicontrol(f,'Style','pushbutton','String','Export PNG','Units','normalized','Position',[0.915 0.245 0.075 0.050],'BackgroundColor',[0.10 0.60 0.25],'ForegroundColor','w','FontWeight','bold','FontSize',10,'Callback',@(src,evt)fcExportLargeView_GA_20260622(f));

...
try
    ...
    fcGASetLabelPos_20260624(pTop,'Color:',[0.650 row2 0.065 hLab],fsLab);
    try, if isfield(S,'hFCColorMap') && ishghandle(S.hFCColorMap), set(S.hFCColorMap,'Parent',pTop,'Units','normalized','Position',[0.720 row2+0.006 0.125 hCtl],'FontSize',fsCtl); end, catch, end
